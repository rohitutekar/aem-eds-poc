import { $ as e, A as t, B as n, C as r, D as i, E as a, F as o, G as s, H as c, I as l, J as u, K as d, L as f, M as p, N as m, O as h, P as g, Q as _, R as v, S as y, T as b, U as x, V as S, W as C, X as w, Y as T, Z as E, _ as D, a as O, at as k, b as A, ct as j, d as M, dt as N, et as P, f as F, ft as I, g as L, h as ee, i as R, it as te, j as z, k as ne, l as re, lt as ie, m as B, n as V, nt as ae, o as oe, ot as se, p as ce, pt as le, q as ue, r as H, rt as U, s as de, st as fe, t as pe, tt as me, u as he, ut as ge, v as _e, w as ve, x as ye, y as be, z as W } from "./src-CgYYaxWK.js";
import { a as xe, i as Se, n as Ce, r as we, t as Te } from "./Button-DEkIjh0g.js";
//#region ../../packages/ui-react/src/brands/DiscoveryLogo.tsx
var G = fe();
function Ee({ title: e, height: t = 16, className: n, ...r }) {
	let i = e ? {
		role: "img",
		"aria-label": e
	} : {
	...
	return /* @__PURE__ */ (0, G.jsxs)("svg", {
		...
		height: t,
		style: { width: "auto" },
		className: j("shrink-0", n),
		...i,
		...r,
		children: [e ? /* @__PURE__ */ (0, G.jsx)("title", { children: e }) : null, /* @__PURE__ */ (0, G.jsx)("path", {
			fillRule: "evenodd",
			clipRule: "evenodd",
...
function De({ title: e, height: t = 16, className: n, ...r }) {
	let i = e ? {
		role: "img",
		"aria-label": e
	} : {
...
function Oe({ title: e, height: t = 16, className: n, ...r }) {
	let i = e ? {
		role: "img",
		"aria-label": e
	} : {
	...
	return /* @__PURE__ */ (0, G.jsxs)("svg", {
		...
		...i,
		...r,
		children: [e ? /* @__PURE__ */ (0, G.jsx)("title", { children: e }) : null, /* @__PURE__ */ (0, G.jsxs)("g", { children: [
...
function ke({ brand: e, ...t }) {
	switch (e) {
		case "range-rover": return /* @__PURE__ */ (0, G.jsx)(Oe, { ...t });
		case "jaguar": return /* @__PURE__ */ (0, G.jsx)(De, { ...t });
		case "discovery": return /* @__PURE__ */ (0, G.jsx)(Ee, { ...t });
	}
}
//#endregion
...
var Ae = "react-aria-clear-focus", je = "react-aria-focus";
//#endregion
...
function Re(e) {
	return e instanceof HTMLInputElement && !Le.has(e.type) || e instanceof HTMLTextAreaElement || e instanceof HTMLElement && e.isContentEditable;
}
//#endregion
...
function Ue(e) {
	if (Intl.Locale) {
		...
		if (t.script) return Ve.has(t.script);
	}
	let t = e.split("-")[0];
	return He.has(t);
}
...
var We = Symbol.for("react-aria.i18n.locale");
function Ge() {
	let e = typeof window < "u" && window[We] || typeof navigator < "u" && (navigator.language || navigator.userLanguage) || "en-US";
	try {
	...
	return {
		locale: e,
		direction: Ue(e) ? "rtl" : "ltr"
	};
}
var Ke = Ge(), qe = /* @__PURE__ */ new Set();
function Je() {
	Ke = Ge();
	for (let e of qe) e(Ke);
}
function Ye() {
	let e = ae(), [t, n] = (0, K.useState)(Ke);
	return (0, K.useEffect)(() => (qe.size === 0 && window.addEventListener("languagechange", Je), qe.add(n), () => {
		qe.delete(n), qe.size === 0 && window.removeEventListener("languagechange", Je);
	}), []), e ? {
		locale: typeof window < "u" && window[We] || "en-US",
		direction: "ltr"
	} : t;
}
//#endregion
...
var Xe = /*#__PURE__*/ K.createContext(null);
function Ze() {
	let e = Ye();
	return (0, K.useContext)(Xe) || e;
}
//#endregion
...
var Qe = Symbol.for("react-aria.i18n.locale"), $e = Symbol.for("react-aria.i18n.strings"), et = void 0, tt = class e {
	...
	getStringsForLocale(e) {
		...
		return t || (t = nt(e, this.strings, this.defaultLocale), this.strings[e] = t), t;
	}
	static getGlobalDictionaryForPackage(t) {
		...
		if (et === void 0) {
			...
			if (!t) return null;
			et = {};
			for (let r in t) et[r] = new e({ [n]: t[r] }, n);
		}
		let r = et?.[t];
...
var it = /* @__PURE__ */ new Map(), at = /* @__PURE__ */ new Map(), ot = class {
	constructor(e, t) {
	...
	plural(e, t, n = "cardinal") {
		...
		let i = this.locale + ":" + n, a = it.get(i);
		return a || (a = new Intl.PluralRules(this.locale, { type: n }), it.set(i, a)), r = t[a.select(e)] || t.other, typeof r == "function" ? r() : r;
	}
	number(e) {
		let t = at.get(this.locale);
		return t || (t = new Intl.NumberFormat(this.locale), at.set(this.locale, t)), t.format(e);
	}
	select(e, t) {
		let n = e[t] || e.other;
...
function ct(e) {
	let t = st.get(e);
	return t || (t = new tt(e), st.set(e, t)), t;
}
function lt(e, t) {
	return t && tt.getGlobalDictionaryForPackage(t) || ct(e);
}
function ut(e, t) {
	let { locale: n } = Ze(), r = lt(e, t);
	return (0, K.useMemo)(() => new ot(n, r), [n, r]);
}
//#endregion
...
var dt = typeof document < "u" ? K.useInsertionEffect ?? K.useLayoutEffect : () => {};
function ft(e, t, n) {
	let [r, i] = (0, K.useState)(e || t), a = (0, K.useRef)(r), o = (0, K.useRef)(e !== void 0), s = e !== void 0;
	(0, K.useEffect)(() => {
	...
	let [, l] = (0, K.useReducer)(() => ({}), {});
	return [c, (0, K.useCallback)((e, ...t) => {
...
var pt = /*#__PURE__*/ (0, K.createContext)(null), mt = /*#__PURE__*/ (0, K.createContext)(null), ht = class {
	constructor(e) {
	...
	filter(e, t, n) {
		let [r, i] = yt(e, t, this.firstChildKey, n), a = this.clone();
...
var vt = class {
	...
	*[Symbol.iterator]() {
	...
	filter(e) {
		let t = new this.constructor(), [n, r] = yt(this, t, this.firstKey, e);
...
var bt = class {
	...
	*[Symbol.iterator]() {
	...
	updateCollection() {
		for (let e of this.dirtyNodes) e instanceof xt && (!e.isConnected || e.isHidden) ? this.removeNode(e) : e.updateChildIndices();
		for (let e of this.dirtyNodes) e instanceof xt ? (e.isConnected && !e.isHidden && (e.updateNode(), this.addNode(e)), e.node && this.dirtyNodes.delete(e), e.isMutated = !1) : this.dirtyNodes.delete(e);
...
function Ct(e) {
	let { children: t, items: n, idScope: r, addIdAndValue: i, dependencies: a = [] } = e, o = (0, K.useMemo)(() => void 0, [t]), s = (0, K.useMemo)(() => /* @__PURE__ */ new WeakMap(), [...a, o]);
	return (0, K.useMemo)(() => {
		if (n && typeof t == "function") {
			let e = [];
			for (let a of n) {
				let n = wt(a) ? a : null, o = n ? s.get(n) : null;
				if (!o) {
					o = t(a);
					let c = o.props.id ?? a?.key ?? a?.id;
					r != null && o.props.id == null && c != null && (c = r + ":" + c);
					let l = c ?? e.length;
					o = (0, K.cloneElement)(o, i ? {
						key: l,
						id: c,
						value: a
					} : { key: l }), n && s.set(n, o);
...
var Tt = /* @__PURE__ */ I(((e) => {
	...
	t.exports = Tt();
})), Dt = /* @__PURE__ */ le(ge(), 1), Ot = Et(), kt = /*#__PURE__*/ (0, K.createContext)(!1), At = /*#__PURE__*/ (0, K.createContext)(null);
function jt(e) {
	if ((0, K.useContext)(At)) return e.content;
	let { collection: t, document: n } = Ft(e.createCollection);
	return /*#__PURE__*/ K.createElement(K.Fragment, null, /*#__PURE__*/ K.createElement(Se, null, /*#__PURE__*/ K.createElement(At.Provider, { value: n }, e.content)), /*#__PURE__*/ K.createElement(Mt, {
		render: e.children,
		collection: t
	}));
}
function Mt({ collection: e, render: t }) {
	return t(e);
}
function Nt(e, t, n) {
	let r = ae(), i = (0, K.useRef)(r);
	return i.current = r, (0, Ot.useSyncExternalStore)(e, (0, K.useCallback)(() => i.current ? n() : t(), [t, n]));
}
var Pt = typeof K.useSyncExternalStore == "function" ? K.useSyncExternalStore : Nt;
function Ft(e) {
	let [t] = (0, K.useState)(() => new St(e?.() || new vt()));
	return {
		collection: Pt((0, K.useCallback)((e) => t.subscribe(e), [t]), (0, K.useCallback)(() => {
			let e = t.getCollection();
			return t.isSSR && t.resetAfterSSR(), e;
		}, [t]), (0, K.useCallback)(() => (t.isSSR = !0, t.getCollection()), [t])),
		document: t
	};
}
var It = /*#__PURE__*/ (0, K.createContext)(null);
function Lt(e) {
...
function Rt(e, t, n, r, i, a) {
	...
	if (s) {
		...
		return o || (o = s.ownerDocument.createElement(e.type), o.setProps(t, n, e, r, a), s.appendChild(o), s.ownerDocument.updateCollection(), s.ownerDocument.nodesByProps.set(t, o)), i ? /*#__PURE__*/ K.createElement(It.Provider, { value: o }, i) : null;
	}
	return /*#__PURE__*/ K.createElement(e.type, { ref: o }, i);
}
function zt(e, t) {
	let n = ({ node: e }) => t(e.props, e.props.ref, e), r = (0, K.forwardRef)((r, i) => {
		let a = (0, K.useContext)(L);
		if (!(0, K.useContext)(kt)) {
			if (t.length >= 3) throw Error(t.name + " cannot be rendered outside a collection.");
			return t(r, i);
		}
		return Rt(e, r, i, "children" in r ? r.children : null, null, (e) => /*#__PURE__*/ K.createElement(L.Provider, { value: a }, /*#__PURE__*/ K.createElement(n, { node: e })));
	});
...
var Vt = /*#__PURE__*/ (0, K.createContext)(null);
function Ht(e) {
	let t = (0, K.useContext)(Vt), n = (t?.dependencies || []).concat(e.dependencies), r = e.idScope ?? t?.idScope, i = Bt({
		...e,
		idScope: r,
		dependencies: n
	});
	return (0, K.useContext)(At) && (i = /*#__PURE__*/ K.createElement(Ut, null, i)), t = (0, K.useMemo)(() => ({
		dependencies: n,
		idScope: r
	}), [r, ...n]), /*#__PURE__*/ K.createElement(Vt.Provider, { value: t }, i);
}
function Ut({ children: e }) {
	let t = (0, K.useContext)(At), n = (0, K.useMemo)(() => /*#__PURE__*/ K.createElement(At.Provider, { value: null }, /*#__PURE__*/ K.createElement(kt.Provider, { value: !0 }, e)), [e]);
	return ae() ? /*#__PURE__*/ K.createElement(It.Provider, { value: t }, n) : /*#__PURE__*/ (0, Dt.createPortal)(n, t);
}
//#endregion
...
var Wt = /*#__PURE__*/ (0, K.createContext)(null), Gt = {
...
function Kt(e, t, n) {
	return Ct({
		...
		dependencies: [n],
		children(t) {
			if (t.type === "content") return /*#__PURE__*/ K.createElement(K.Fragment, null);
			let r = t.render(t);
			return !n || t.type !== "item" ? r : /*#__PURE__*/ K.createElement(K.Fragment, null, n({
				type: "item",
				key: t.key,
				dropPosition: "before"
			}), r, qt(e, t, n));
...
function qt(e, t, n) {
	...
	if (o == null) {
		...
		for (; r?.type === "item" && (!a || r.parentKey !== a.parentKey && a.level < r.level);) {
			...
			/*#__PURE__*/ (0, K.isValidElement)(t) && s.push(/*#__PURE__*/ (0, K.cloneElement)(t, { key: `${r.key}-after` })), r = r.parentKey == null ? null : e.getItem(r.parentKey);
		}
	}
	return s;
}
var Jt = /*#__PURE__*/ (0, K.createContext)(Gt);
function Yt(e) {
	return (0, K.useMemo)(() => e == null ? null : /* @__PURE__ */ new Set([e]), [e]);
}
//#endregion
//#region ../../node_modules/.pnpm/react-stately@3.48.0_react@19.2.4/node_modules/react-stately/dist/private/utils/number.mjs
function Xt(e, t = -Infinity, n = Infinity) {
...
var Zt = /*#__PURE__*/ (0, K.createContext)({}), Qt = /*#__PURE__*/ (0, K.forwardRef)(function(e, t) {
	[e, t] = s(e, t, Zt);
	let { children: n, level: r = 3, className: i, ...a } = e, o = T[`h${r}`];
	return /*#__PURE__*/ K.createElement(o, {
		...a,
		ref: t,
		className: i ?? "react-aria-Heading"
	}, n);
}), $t = /*#__PURE__*/ (0, K.createContext)({});
//#endregion
...
function tn(e, t) {
	let n = e;
	for (en(n, t) && (n = n.parentElement); n && !en(n, t);) n = n.parentElement;
...
function nn(e, t) {
	...
	for (; e && (en(e, t) && n.push(e), e !== r);) e = e.parentElement;
	return n;
}
//#endregion
...
function rn(e, t, n = {}) {
	...
	if (e === t) return;
	let a = e.scrollTop, o = e.scrollLeft, s = t.getBoundingClientRect(), c = e.getBoundingClientRect(), l = window.getComputedStyle(t), u = window.getComputedStyle(e), d = document.scrollingElement || document.documentElement, f = e === d, p = e === d ? 0 : c.top, h = e === d ? e.clientHeight : c.bottom, g = e === d ? 0 : c.left, _ = e === d ? e.clientWidth : c.right, v = parseFloat(l.scrollMarginTop) || 0, y = parseFloat(l.scrollMarginBottom) || 0, b = parseFloat(l.scrollMarginLeft) || 0, x = parseFloat(l.scrollMarginRight) || 0, S = parseFloat(u.scrollPaddingTop) || 0, C = parseFloat(u.scrollPaddingBottom) || 0, w = parseFloat(u.scrollPaddingLeft) || 0, T = parseFloat(u.scrollPaddingRight) || 0, E = parseFloat(u.borderTopWidth) || 0, D = parseFloat(u.borderBottomWidth) || 0, O = parseFloat(u.borderLeftWidth) || 0, k = parseFloat(u.borderRightWidth) || 0, A = s.top - v, j = s.bottom + y, M = s.left - b, N = s.right + x, P = e === d ? 0 : O + k, F = e === d ? 0 : E + D, I = e === d ? 0 : e.offsetWidth - e.clientWidth - P, L = e === d ? 0 : e.offsetHeight - e.clientHeight - F, ee = p + (f ? 0 : E) + S, R = h - (f ? 0 : D) - C - L, te = g + (f ? 0 : O) + w, z = _ - (f ? 0 : k) - T;
	u.direction === "rtl" && !m() ? te += I : z -= I;
	let ne = A < ee || j > R, re = M < te || N > z;
	if (ne && r === "start") a += A - ee;
	else if (ne && r === "center") a += (A + j) / 2 - (ee + R) / 2;
	else if (ne && r === "end") a += j - R;
	else if (ne && r === "nearest") {
		let e = A - ee, t = j - R;
		a += Math.abs(e) <= Math.abs(t) ? e : t;
	}
	if (re && i === "start") o += M - te;
	else if (re && i === "center") o += (M + N) / 2 - (te + z) / 2;
	else if (re && i === "end") o += N - z;
	else if (re && i === "nearest") {
		let e = M - te, t = N - z;
...
function an(e, t = {}) {
	...
	if (e && e.isConnected) {
		...
		if (window.getComputedStyle(t).overflow !== "hidden") {
			...
			let { left: t, top: r } = e.getBoundingClientRect(), i = nn(e, !0);
			for (let t of i) rn(t, e);
			let { left: a, top: o } = e.getBoundingClientRect();
			if (Math.abs(t - a) > 1 || Math.abs(r - o) > 1) {
				i = n ? nn(n, !0) : [];
				for (let e of i) rn(e, n, {
					block: "center",
					inline: "center"
				});
				for (let t of nn(e, !0)) rn(t, e);
			}
		}
	}
}
...
function cn(e) {
	...
	return U(() => {
		...
		if (t) n(t.element.id);
			...
			let r = `react-aria-description-${on++}`;
			n(r);
		...
		return t.refCount++, () => {
			t && --t.refCount === 0 && (t.element.remove(), sn.delete(e));
		};
...
function un(e = {}) {
	let { style: t, isFocusable: n } = e, [r, i] = (0, K.useState)(!1), { focusWithinProps: a } = re({
		isDisabled: !n,
...
function dn(e) {
	let { children: t, elementType: n = "div", isFocusable: r, style: i, ...a } = e, { visuallyHiddenProps: o } = un(e);
	return /*#__PURE__*/ K.createElement(n, _(a, o), t);
}
//#endregion
...
var fn = /*#__PURE__*/ (0, K.createContext)({}), pn = /*#__PURE__*/ (0, K.createContext)(null);
function mn(e) {
	let t = (0, K.useRef)({});
	return /*#__PURE__*/ K.createElement(pn.Provider, { value: t }, e.children);
}
//#endregion
...
var hn = /*#__PURE__*/ (0, K.createContext)({ isSelected: !1 }), gn = /*#__PURE__*/ (0, K.createContext)({});
(class extends ht {
	static {
		this.type = "separator";
	}
...
function vn(e, t, n, r) {
	return S() ? new _n(e, t, n, r) : e.createTreeWalker(t, n, r);
}
//#endregion
...
var yn = /*#__PURE__*/ K.createContext(null), bn = "react-aria-focus-scope-restore", q = null;
function xn(e) {
	let { children: t, contain: n, restoreFocus: r, autoFocus: i } = e, a = (0, K.useRef)(null), o = (0, K.useRef)(null), s = (0, K.useRef)([]), { parentNode: l } = (0, K.useContext)(yn) || {}, u = (0, K.useMemo)(() => new Hn({ scopeRef: s }), [s]);
	U(() => {
		let e = l || Y.root;
		if (Y.getTreeNode(e.scopeRef) && q && !jn(q, e.scopeRef)) {
			let t = Y.getTreeNode(q);
			t && (e = t);
		}
		e.addChild(u), Y.addNode(u);
	}, [u, l]), U(() => {
		let e = Y.getTreeNode(s);
		e && (e.contain = !!n);
	}, [n]), U(() => {
		let e = a.current?.nextSibling, t = [], n = (e) => e.stopPropagation();
		for (; e && e !== o.current;) t.push(e), e.addEventListener(bn, n), e = e.nextSibling;
		return s.current = t, () => {
			for (let e of t) e.removeEventListener(bn, n);
		};
	}, [t]), In(s, r, n), Dn(s, n), Rn(s, r, n), Fn(s, i), (0, K.useEffect)(() => {
		let e = W(c(s.current ? s.current[0] : void 0)), t = null;
		if (J(e, s.current)) {
			for (let n of Y.traverse()) n.scopeRef && J(e, n.scopeRef.current) && (t = n);
			t === Y.getTreeNode(s) && (q = t.scopeRef);
		}
	}, [s]), U(() => () => {
		let e = Y.getTreeNode(s)?.parent?.scopeRef ?? null;
		(s === q || jn(s, q)) && (!e || Y.getTreeNode(e)) && (q = e), Y.removeTreeNode(s);
	}, [s]);
	let d = (0, K.useMemo)(() => Sn(s), []), f = (0, K.useMemo)(() => ({
		focusManager: d,
		parentNode: u
	}), [u, d]);
	return /*#__PURE__*/ K.createElement(yn.Provider, { value: f }, /*#__PURE__*/ K.createElement("span", {
...
function Sn(e) {
	return {
		focusNext(t = {}) {
			let n = e.current, { from: r, tabbable: i, wrap: a, accept: o } = t, s = r || W(c(n[0] ?? void 0)), l = n[0].previousElementSibling, u = Bn(Cn(n), {
				tabbable: i,
				accept: o
			}, n);
			u.currentNode = J(s, n) ? s : l;
			let d = u.nextNode();
			return !d && a && (u.currentNode = l, d = u.nextNode()), d && Mn(d, !0), d;
		},
		focusPrevious(t = {}) {
			let n = e.current, { from: r, tabbable: i, wrap: a, accept: o } = t, s = r || W(c(n[0] ?? void 0)), l = n[n.length - 1].nextElementSibling, u = Bn(Cn(n), {
				tabbable: i,
				accept: o
			}, n);
			u.currentNode = J(s, n) ? s : l;
			let d = u.previousNode();
			return !d && a && (u.currentNode = l, d = u.previousNode()), d && Mn(d, !0), d;
		},
		focusFirst(t = {}) {
			let n = e.current, { tabbable: r, accept: i } = t, a = Bn(Cn(n), {
				tabbable: r,
				accept: i
			}, n);
...
function Tn(e) {
	if (!e.form) return Array.from(c(e).querySelectorAll(`input[type="radio"][name="${CSS.escape(e.name)}"]`)).filter((e) => !e.form);
	let t = e.form.elements.namedItem(e.name), n = x(e);
...
function Dn(e, t) {
	let r = (0, K.useRef)(void 0), i = (0, K.useRef)(void 0);
	U(() => {
		let a = e.current;
		if (!t) {
			i.current &&= (cancelAnimationFrame(i.current), void 0);
			return;
		}
		let o = c(a ? a[0] : void 0), s = (t) => {
			if (t.key !== "Tab" || t.altKey || t.ctrlKey || t.metaKey || !wn(e) || t.isComposing) return;
			let n = W(o), r = e.current;
			if (!r || !J(n, r)) return;
			let i = Bn(Cn(r), { tabbable: !0 }, r);
			if (!n) return;
			i.currentNode = n;
			let a = t.shiftKey ? i.previousNode() : i.nextNode();
			a ||= (i.currentNode = t.shiftKey ? r[r.length - 1].nextElementSibling : r[0].previousElementSibling, t.shiftKey ? i.previousNode() : i.nextNode()), t.preventDefault(), a && (Mn(a, !0), a instanceof x(a).HTMLInputElement && a.select());
		}, l = (t) => {
			(!q || jn(q, e)) && J(n(t), e.current) ? (q = e, r.current = n(t)) : wn(e) && !kn(n(t), e) ? r.current ? r.current.focus() : q && q.current && Pn(q.current) : wn(e) && (r.current = n(t));
		}, u = (t) => {
			i.current && cancelAnimationFrame(i.current), i.current = requestAnimationFrame(() => {
				let i = ye(), a = (i === "virtual" || i === null) && z() && h(), s = W(o);
				if (!a && s && wn(e) && !kn(s, e)) {
					q = e;
					let i = n(t);
					i && i.isConnected ? (r.current = i, r.current?.focus()) : q.current && Pn(q.current);
				}
			});
		};
		return o.addEventListener("keydown", s, !1), o.addEventListener("focusin", l, !1), a?.forEach((e) => e.addEventListener("focusin", l, !1)), a?.forEach((e) => e.addEventListener("focusout", u, !1)), () => {
			o.removeEventListener("keydown", s, !1), o.removeEventListener("focusin", l, !1), a?.forEach((e) => e.removeEventListener("focusin", l, !1)), a?.forEach((e) => e.removeEventListener("focusout", u, !1));
		};
	}, [e, t]), U(() => () => {
...
function kn(e, t = null) {
	...
	for (let { scopeRef: n } of Y.traverse(Y.getTreeNode(t))) if (n && J(e, n.current)) return !0;
	return !1;
}
function An(e) {
	return kn(e, q);
...
function Nn(e, t = !0) {
	let n = e[0].previousElementSibling, r = Cn(e), i = Bn(r, { tabbable: t }, e);
	i.currentNode = n;
	let a = i.nextNode();
	return t && !a && (r = Cn(e), i = Bn(r, { tabbable: !1 }, e), i.currentNode = n, a = i.nextNode()), a;
}
function Pn(e, t = !0) {
	Mn(Nn(e, t));
}
function Fn(e, t) {
	let n = K.useRef(t);
	(0, K.useEffect)(() => {
		n.current && (q = e, !J(W(c(e.current ? e.current[0] : void 0)), q.current) && e.current && Pn(e.current)), n.current = !1;
	}, [e]);
}
function In(e, t, r) {
	U(() => {
		if (t || r) return;
		let i = e.current, a = c(i ? i[0] : void 0), o = (t) => {
			let r = n(t);
			J(r, e.current) ? q = e : On(r) || (q = null);
		};
		return a.addEventListener("focusin", o, !1), i?.forEach((e) => e.addEventListener("focusin", o, !1)), () => {
			a.removeEventListener("focusin", o, !1), i?.forEach((e) => e.removeEventListener("focusin", o, !1));
		};
	}, [
		e,
		t,
...
function Rn(e, t, n) {
	let r = (0, K.useRef)(typeof document < "u" ? W(c(e.current ? e.current[0] : void 0)) : null);
	U(() => {
		let r = e.current, i = c(r ? r[0] : void 0);
		if (!t || n) return;
		let a = () => {
			(!q || jn(q, e)) && J(W(i), e.current) && (q = e);
		};
		...
		let r = c(e.current ? e.current[0] : void 0);
		if (!t) return;
		let i = (t) => {
			if (t.key !== "Tab" || t.altKey || t.ctrlKey || t.metaKey || !wn(e) || t.isComposing) return;
			let n = r.activeElement;
			if (!kn(n, e) || !Ln(e)) return;
			let i = Y.getTreeNode(e);
			if (!i) return;
			let a = i.nodeToRestore, o = Bn(r.body, { tabbable: !0 });
			o.currentNode = n;
			let s = t.shiftKey ? o.previousNode() : o.nextNode();
			if ((!a || !a.isConnected || a === r.body) && (a = void 0, i.nodeToRestore = void 0), (!s || !kn(s, e)) && a) {
				o.currentNode = a;
				do
					s = t.shiftKey ? o.previousNode() : o.nextNode();
				while (kn(s, e));
				t.preventDefault(), t.stopPropagation(), s ? Mn(s, !0) : On(a) ? Mn(a, !0) : n.blur();
			}
		};
		...
		let n = c(e.current ? e.current[0] : void 0);
		if (!t) return;
		let i = Y.getTreeNode(e);
		if (i) return i.nodeToRestore = r.current ?? void 0, () => {
			let r = Y.getTreeNode(e);
			if (!r) return;
			let i = r.nodeToRestore, a = W(n);
			if (t && i && (a && kn(a, e) || a === n.body && Ln(e))) {
				let t = Y.clone();
				requestAnimationFrame(() => {
					if (n.activeElement === n.body) {
						...
						for (n = t.getTreeNode(e); n;) {
							if (n.scopeRef && n.scopeRef.current && Y.getTreeNode(n.scopeRef)) {
								zn(Nn(n.scopeRef.current, !0));
								return;
							}
							n = n.parent;
						}
...
function zn(e) {
	e.dispatchEvent(new CustomEvent(bn, {
		bubbles: !0,
		cancelable: !0
	})) && Mn(e);
}
function Bn(e, t, n) {
	let r = t?.tabbable ? o : g, i = c(e?.nodeType === Node.ELEMENT_NODE ? e : null), a = vn(i, e || i, NodeFilter.SHOW_ELEMENT, { acceptNode(e) {
		return f(t?.from, e) || t?.tabbable && e.tagName === "INPUT" && e.getAttribute("type") === "radio" && (!En(e) || a.currentNode.tagName === "INPUT" && a.currentNode.type === "radio" && a.currentNode.name === e.name) ? NodeFilter.FILTER_REJECT : r(e) && (!n || J(e, n)) && (!t?.accept || t.accept(e)) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP;
	} });
	return t?.from && (a.currentNode = t.from), a;
}
var Vn = class e {
	constructor() {
		this.fastMap = /* @__PURE__ */ new Map(), this.root = new Hn({ scopeRef: null }), this.fastMap.set(null, this.root);
	}
	get size() {
	...
	removeTreeNode(e) {
		...
		if (!t) return;
		let n = t.parent;
		for (let e of this.traverse()) e !== t && t.nodeToRestore && e.nodeToRestore && t.scopeRef && t.scopeRef.current && J(e.nodeToRestore, t.scopeRef.current) && (e.nodeToRestore = t.nodeToRestore);
		let r = t.children;
...
var Jn = 1e3;
function Yn(e) {
	let { keyboardDelegate: t, selectionManager: r, onTypeSelect: i } = e, a = (0, K.useRef)({
		search: "",
		timeout: void 0
	});
	return (0, K.useEffect)(() => {
		let e = a.current.timeout;
		return () => {
			clearTimeout(e);
		};
	}, [a]), { typeSelectProps: {
		onKeyDownCapture: t.getKeyForSearch ? (e) => {
			if (a.current.search.length > 0 && e.key === " ") {
				if (e.preventDefault(), (!("continuePropagation" in e) || "continuePropagation" in e && !e.isPropagationStopped()) && e.stopPropagation(), a.current.search += " ", t.getKeyForSearch != null) {
					let e = t.getKeyForSearch(a.current.search, r.focusedKey);
					e ??= t.getKeyForSearch(a.current.search), e != null && (r.setFocusedKey(e), i && i(e));
				}
				clearTimeout(a.current.timeout), a.current.timeout = setTimeout(() => {
					a.current.search = "";
				}, Jn);
			}
		} : void 0,
		onKeyDown: t.getKeyForSearch ? (e) => {
			let o = Xn(e.key);
			if (!(!o || e.ctrlKey || e.metaKey || e.altKey || !f(e.currentTarget, n(e)) || a.current.search.length === 0 && o === " ")) {
				if (a.current.search += o, t.getKeyForSearch != null) {
					let n = t.getKeyForSearch(a.current.search, r.focusedKey);
					if (n ??= t.getKeyForSearch(a.current.search), n != null) r.setFocusedKey(n), i && i(n), e.preventDefault(), "continuePropagation" in e || e.stopPropagation();
					else {
						a.current.search = "", clearTimeout(a.current.timeout), a.current.timeout = void 0;
						return;
					}
				}
				clearTimeout(a.current.timeout), a.current.timeout = setTimeout(() => {
...
function Zn(e, t) {
	let n = (0, K.useRef)(!0), r = (0, K.useRef)(null);
	U(() => (n.current = !0, () => {
		n.current = !1;
	}), []), U(() => {
...
function Qn(e) {
	let { selectionManager: t, keyboardDelegate: r, ref: a, autoFocus: s = !1, shouldFocusWrap: c = !1, disallowEmptySelection: u = !1, disallowSelectAll: d = !1, escapeKeyBehavior: p = "clearSelection", selectOnFocus: m = t.selectionBehavior === "replace", disallowTypeAhead: h = !1, shouldUseVirtualFocus: g, allowsTabNavigation: y = !1, scrollRef: b = a, linkBehavior: x = "action", UNSTABLE_focusOnEntry: S } = e, { direction: C } = Ze(), w = i(), T = (e) => {
		if (e.altKey && e.key === "Tab" && e.preventDefault(), !a.current || !f(a.current, n(e))) return;
		let i = (n, r) => {
			if (n != null) {
				if (t.isLink(n) && x === "selection" && m && !Un(e)) {
					(0, Dt.flushSync)(() => {
						t.setFocusedKey(n, r);
					});
					let i = Wn(a, n), o = t.getItemProps(n);
					i && w.open(i, e, o.href, o.routerOptions);
					return;
				}
				if (t.setFocusedKey(n, r), t.isLink(n) && x === "override") return;
				e.shiftKey && t.selectionMode === "multiple" ? t.extendSelection(n) : m && !Un(e) && t.replaceSelection(n);
			}
		};
		switch (e.key) {
			case "ArrowDown":
				if (r.getKeyBelow) {
					let n = t.focusedKey == null ? r.getFirstKey?.() : r.getKeyBelow?.(t.focusedKey);
					n == null && c && (n = r.getFirstKey?.(t.focusedKey)), n != null && (e.preventDefault(), i(n));
				}
				break;
			case "ArrowUp":
				if (r.getKeyAbove) {
					let n = t.focusedKey == null ? r.getLastKey?.() : r.getKeyAbove?.(t.focusedKey);
					n == null && c && (n = r.getLastKey?.(t.focusedKey)), n != null && (e.preventDefault(), i(n));
				}
				break;
			case "ArrowLeft":
				if (r.getKeyLeftOf) {
					let n = t.focusedKey == null ? r.getFirstKey?.() : r.getKeyLeftOf?.(t.focusedKey);
					n == null && c && (n = C === "rtl" ? r.getFirstKey?.(t.focusedKey) : r.getLastKey?.(t.focusedKey)), n != null && (e.preventDefault(), i(n, C === "rtl" ? "first" : "last"));
				}
				break;
			case "ArrowRight":
				if (r.getKeyRightOf) {
					let n = t.focusedKey == null ? r.getFirstKey?.() : r.getKeyRightOf?.(t.focusedKey);
					n == null && c && (n = C === "rtl" ? r.getLastKey?.(t.focusedKey) : r.getFirstKey?.(t.focusedKey)), n != null && (e.preventDefault(), i(n, C === "rtl" ? "last" : "first"));
				}
				break;
			case "Home":
				if (r.getFirstKey) {
					...
					e.preventDefault();
					let n = r.getFirstKey(t.focusedKey, Ie(e));
					t.setFocusedKey(n), n != null && (Ie(e) && e.shiftKey && t.selectionMode === "multiple" ? t.extendSelection(n) : m && t.replaceSelection(n));
				}
				break;
			case "End":
				if (r.getLastKey) {
					if (t.focusedKey === null && e.shiftKey) return;
					e.preventDefault();
					let n = r.getLastKey(t.focusedKey, Ie(e));
					t.setFocusedKey(n), n != null && (Ie(e) && e.shiftKey && t.selectionMode === "multiple" ? t.extendSelection(n) : m && t.replaceSelection(n));
				}
				break;
			case "PageDown":
				if (r.getKeyPageBelow && t.focusedKey != null) {
					let n = r.getKeyPageBelow(t.focusedKey);
					n != null && (e.preventDefault(), i(n));
				}
				break;
			case "PageUp":
				if (r.getKeyPageAbove && t.focusedKey != null) {
					let n = r.getKeyPageAbove(t.focusedKey);
					n != null && (e.preventDefault(), i(n));
				}
				break;
			case "a":
				Ie(e) && t.selectionMode === "multiple" && d !== !0 && (e.preventDefault(), t.selectAll());
				break;
			case "Escape":
				p === "clearSelection" && !u && t.selectedKeys.size !== 0 && (e.stopPropagation(), e.preventDefault(), t.clearSelection());
				break;
			case "Tab": if (!y) {
				if (e.shiftKey) a.current.focus();
				else {
					let e = Bn(a.current, { tabbable: !0 }), t, n;
					do
						n = e.lastChild(), n && (t = n);
					while (n);
					let r = W();
	...
	let D = (e) => {
		if (t.isFocused) {
			f(e.currentTarget, n(e)) || t.setFocused(!1);
			return;
		}
		if (!f(e.currentTarget, n(e))) return;
		let i = ye();
		t.setFocused(!0);
		let o = (e) => {
			e != null && (t.setFocusedKey(e), m && !t.isSelected(e) && t.replaceSelection(e));
		};
		if (S && (i === "keyboard" || i === "virtual")) o(S === "first" ? r.getFirstKey?.() : r.getLastKey?.());
		else if (t.focusedKey == null) {
			let n = e.relatedTarget;
			n && e.currentTarget.compareDocumentPosition(n) & Node.DOCUMENT_POSITION_FOLLOWING ? o(t.lastSelectedKey ?? r.getLastKey?.()) : o(t.firstSelectedKey ?? r.getFirstKey?.());
		} else b.current && (b.current.scrollTop = E.current.top, b.current.scrollLeft = E.current.left);
		if (t.focusedKey != null && b.current) {
			let e = Wn(a, t.focusedKey);
			e instanceof HTMLElement && (!v(e) && !g && l(e), (i === "keyboard" || S && i === "virtual") && an(e, { containingElement: a.current }));
		}
	}, O = (e) => {
	...
	let A = r.getFirstKey?.() ?? null;
	Zn(() => {
		if (k.current) if (A == null) {
			let e = W();
			Me(a.current), Pe(e, null), t.collection.size > 0 && (k.current = !1);
		} else t.setFocusedKey(A), k.current = !1;
	}, [A, t.collection.size]), Zn(() => {
		t.collection.size > 0 && (k.current = !1);
	}, [t.focusedKey]), ze(a, Ae, g ? (e) => {
		e.stopPropagation(), t.setFocused(!1), e.detail?.clearFocusKey && t.setFocusedKey(null);
	} : void 0);
	let j = (0, K.useRef)(s), M = (0, K.useRef)(!1);
	(0, K.useEffect)(() => {
		if (j.current) {
			let e = null;
			s === "first" && (e = r.getFirstKey?.() ?? null), s === "last" && (e = r.getLastKey?.() ?? null);
			let n = t.selectedKeys;
			if (n.size) {
				for (let r of n) if (t.canSelectItem(r)) {
					e = r;
					break;
				}
			}
			t.setFocused(!0), t.setFocusedKey(e), e == null && !g && a.current && be(a.current), t.collection.size > 0 && (j.current = !1, M.current = !0);
		}
	});
	let N = (0, K.useRef)(t.focusedKey), P = (0, K.useRef)(null);
	(0, K.useEffect)(() => {
		if (t.isFocused && t.focusedKey != null && (t.focusedKey !== N.current || M.current) && b.current && a.current) {
			let e = ye(), n = Wn(a, t.focusedKey);
			if (!(n instanceof HTMLElement)) return;
			(e === "keyboard" || M.current) && (P.current && cancelAnimationFrame(P.current), P.current = requestAnimationFrame(() => {
				b.current && (rn(b.current, n), e !== "virtual" && an(n, { containingElement: a.current }));
			}));
		}
		!g && t.isFocused && t.focusedKey == null && N.current != null && a.current && be(a.current), N.current = t.focusedKey, M.current = !1;
	}), (0, K.useEffect)(() => () => {
		P.current && cancelAnimationFrame(P.current);
	}, []), ze(a, "react-aria-focus-scope-restore", (e) => {
	...
	let F = {
		...
		onBlur: O,
		onMouseDown(e) {
			b.current === n(e) && e.preventDefault();
		}
	}, { typeSelectProps: I } = Yn({
		keyboardDelegate: r,
		selectionManager: t
	});
	h || (F = _(I, F));
	let L;
	g || (L = t.focusedKey == null ? 0 : -1);
	let ee = Kn(t.collection);
	return { collectionProps: _(F, {
		tabIndex: L,
		"data-collection": ee
	}) };
}
...
var $n = class {
	...
	getItemRect(e) {
		...
		if (!t) return null;
		let n = e == null ? null : Wn(this.ref, e);
		if (!n) return null;
	...
	constructor(...e) {
		if (e.length === 1) {
			let t = e[0];
			this.collection = t.collection, this.ref = t.ref, this.collator = t.collator, this.disabledKeys = t.disabledKeys || /* @__PURE__ */ new Set(), this.disabledBehavior = t.disabledBehavior || "all", this.orientation = t.orientation || "vertical", this.direction = t.direction, this.layout = t.layout || "stack", this.layoutDelegate = t.layoutDelegate || new $n(t.ref);
		} else this.collection = e[0], this.disabledKeys = e[1], this.ref = e[2], this.collator = e[3], this.layout = "stack", this.orientation = "vertical", this.disabledBehavior = "all", this.layoutDelegate = new $n(this.ref);
	...
	isReversed(e) {
		let t = this.getNextKey(e), n = Wn(this.ref, e);
		if (t != null) {
			let e = Wn(this.ref, t);
	...
	getKeyPageAbove(e) {
		...
		if (t && !en(t)) return this.getFirstKey();
		let i = e;
	...
	getKeyPageBelow(e) {
		...
		if (!n) return null;
		let r = this.isReversed(e);
		if (t && !en(t)) return this.getLastKey();
		let i = e;
		if (this.orientation === "horizontal") {
...
function nr(e) {
	let { locale: t } = Ze(), n = t + (e ? Object.entries(e).sort((e, t) => e[0] < t[0] ? -1 : 1).join() : "");
...
function rr(e) {
	let { selectionManager: t, collection: n, disabledKeys: r, ref: i, keyboardDelegate: a, layoutDelegate: o, orientation: s } = e, c = nr({
		usage: "search",
		sensitivity: "base"
	}), l = t.disabledBehavior, u = (0, K.useMemo)(() => a || new er({
		collection: n,
		disabledKeys: r,
		disabledBehavior: l,
		ref: i,
...
var ir = 500;
function ar(e) {
	let { isDisabled: t, onLongPressStart: n, onLongPressEnd: r, onLongPress: i, threshold: a = ir, accessibilityDescription: o } = e, s = (0, K.useRef)(void 0), { addGlobalListener: u, removeGlobalListener: d } = M(), { pressProps: f } = he({
		isDisabled: t,
		onPressStart(e) {
			if (e.continuePropagation(), (e.pointerType === "mouse" || e.pointerType === "touch") && (n && n({
				...
				e.target.dispatchEvent(new PointerEvent("pointercancel", { bubbles: !0 })), c(e.target).activeElement !== e.target && l(e.target), i && i({
					...e,
					type: "longpress"
				}), s.current = void 0;
				...
				u(e.target, "contextmenu", t, { once: !0 }), u(n, "pointerup", () => {
					setTimeout(() => {
	...
	return { longPressProps: _(f, cn(i && !t ? o : void 0)) };
}
//#endregion
...
function or(e) {
	let { id: t, selectionManager: r, key: o, ref: s, shouldSelectOnPressUp: c, shouldUseVirtualFocus: l, focus: u, isDisabled: d, onAction: f, allowsDifferentPressOrigin: p, linkBehavior: m = "action" } = e, h = i();
	t = me(t);
	let g = (e) => {
		if (e.pointerType === "keyboard" && Un(e)) r.toggleSelection(o);
		else {
			if (r.selectionMode === "none") return;
			if (r.isLink(o)) {
				if (m === "selection" && s.current) {
					let t = r.getItemProps(o);
					h.open(s.current, e, t.href, t.routerOptions), r.setSelectedKeys(r.selectedKeys);
					return;
				} else if (m === "override" || m === "none") return;
			}
			r.selectionMode === "single" ? r.isSelected(o) && !r.disallowEmptySelection ? r.toggleSelection(o) : r.replaceSelection(o) : e && e.shiftKey ? r.extendSelection(o) : r.selectionBehavior === "toggle" || e && (Ie(e) || e.pointerType === "touch" || e.pointerType === "virtual") ? r.toggleSelection(o) : r.replaceSelection(o);
		}
	};
	(0, K.useEffect)(() => {
		o === r.focusedKey && r.isFocused && (l ? Me(s.current) : u ? u() : W() !== s.current && s.current && be(s.current));
	}, [
		s,
		o,
		r.focusedKey,
	...
	!l && !d ? v = {
		...
		onFocus(e) {
			n(e) === s.current && r.setFocusedKey(o);
		}
	} : d && (v.onMouseDown = (e) => {
		e.preventDefault();
	}), (0, K.useEffect)(() => {
		d && r.focusedKey === o && r.setFocusedKey(null);
	}, [
		r,
		d,
		o
	]);
	let y = r.isLink(o) && m === "override", b = f && e.UNSTABLE_itemBehavior === "action", x = r.isLink(o) && m !== "selection" && m !== "none", S = !d && r.canSelectItem(o) && !y && !b, C = (f || x) && !d, w = C && (r.selectionBehavior === "replace" ? !S : !S || r.isEmpty), T = C && S && r.selectionBehavior === "replace", E = w || T, D = (0, K.useRef)(null), O = E && S, k = (0, K.useRef)(!1), A = (0, K.useRef)(!1), j = r.getItemProps(o), M = (e) => {
		f && (f(), s.current?.dispatchEvent(new CustomEvent("react-aria-item-action", { bubbles: !0 }))), x && s.current && h.open(s.current, e, j.href, j.routerOptions);
	}, N = { ref: s };
	if (c ? (N.onPressStart = (e) => {
		D.current = e.pointerType, k.current = O, e.pointerType === "keyboard" && (!E || cr(e.key)) && g(e);
	}, p ? (N.onPressUp = w ? void 0 : (e) => {
		e.pointerType === "mouse" && S && g(e);
	}, N.onPress = w ? M : (e) => {
		e.pointerType !== "keyboard" && e.pointerType !== "mouse" && S && g(e);
	}) : N.onPress = (e) => {
		if (w || T && e.pointerType !== "mouse") {
			if (e.pointerType === "keyboard" && !sr(e.key)) return;
			M(e);
		} else e.pointerType !== "keyboard" && S && g(e);
	}) : (N.onPressStart = (e) => {
		D.current = e.pointerType, k.current = O, A.current = w, S && (e.pointerType === "mouse" && !w || e.pointerType === "keyboard" && (!C || cr(e.key))) && g(e);
	}, N.onPress = (e) => {
		(e.pointerType === "touch" || e.pointerType === "pen" || e.pointerType === "virtual" || e.pointerType === "keyboard" && E && sr(e.key) || e.pointerType === "mouse" && A.current) && (E ? M(e) : S && g(e));
	}), v["data-collection"] = qn(r.collection), v["data-key"] = o, N.preventFocusOnPress = l, l && (N = _(N, {
		onPressStart(e) {
			e.pointerType !== "touch" && (r.setFocused(!0), r.setFocusedKey(o));
		},
		onPress(e) {
			e.pointerType === "touch" && (r.setFocused(!0), r.setFocusedKey(o));
		}
	...
	let { pressProps: P, isPressed: F } = he(N), I = T ? (e) => {
		D.current === "mouse" && (e.stopPropagation(), e.preventDefault(), M(e));
	} : void 0, { longPressProps: L } = ar({
		isDisabled: !O,
		onLongPress(e) {
			e.pointerType === "touch" && (g(e), r.setSelectionBehavior("toggle"));
		}
	}), ee = (e) => {
		D.current === "touch" && k.current && e.preventDefault();
	}, R = m !== "none" && r.isLink(o) ? (e) => {
		a.isOpening || e.preventDefault();
	} : void 0;
	return {
		itemProps: _(v, S || w || l && !d ? P : {}, O ? L : {}, {
			onDoubleClick: I,
			onDragStartCapture: ee,
			onClick: R,
			id: t
		}, l ? { onMouseDown: (e) => e.preventDefault() } : void 0),
		isPressed: F,
...
function fr(e, t, n) {
	...
	let r = [...pr(e, t), t], i = [...pr(e, n), n], a = r.slice(0, i.length).findIndex((e, t) => e !== i[t]);
...
function hr(e) {
	...
	if (t != null) return t;
	let n = 0, r = (t) => {
		for (let i of t) i.type === "section" ? r(lr(i, e)) : i.type === "item" && n++;
	};
	return r(e), mr.set(e, n), n;
}
//#endregion
//#region ../../node_modules/.pnpm/react-stately@3.48.0_react@19.2.4/node_modules/react-stately/dist/private/selection/Selection.mjs
var gr = class e extends Set {
	constructor(t, n, r) {
...
function vr(e) {
	let { selectionMode: t = "none", disallowEmptySelection: n = !1, allowDuplicateSelectionEvents: r, selectionBehavior: i = "toggle", disabledBehavior: a = "all" } = e, o = (0, K.useRef)(!1), [, s] = (0, K.useState)(!1), c = (0, K.useRef)(null), l = (0, K.useRef)(null), [, u] = (0, K.useState)(null), [d, f] = ft((0, K.useMemo)(() => yr(e.selectedKeys), [e.selectedKeys]), (0, K.useMemo)(() => yr(e.defaultSelectedKeys, new gr()), [e.defaultSelectedKeys]), e.onSelectionChange), p = (0, K.useMemo)(() => e.disabledKeys ? new Set(e.disabledKeys) : /* @__PURE__ */ new Set(), [e.disabledKeys]), [m, h] = (0, K.useState)(i);
...
var br = class e {
	...
	get firstSelectedKey() {
		...
		for (let t of this.state.selectedKeys) {
			...
			(!e || n && fr(this.collection, n, e) < 0) && (e = n);
		}
		return e?.key ?? null;
	}
	get lastSelectedKey() {
	...
	extendSelection(e) {
		...
		if (t == null) return;
		let n;
		if (this.state.selectedKeys === "all") n = new gr([t], t, t);
		else {
	...
	getKeyRange(e, t) {
		...
		return n && r ? fr(this.collection, n, r) <= 0 ? this.getKeyRangeInternal(e, t) : this.getKeyRangeInternal(t, e) : [];
	}
	...
	toggleSelection(e) {
		...
		let t = this.getKey(e);
		if (t == null) return;
		let n = new gr(this.state.selectedKeys === "all" ? this.getSelectAllKeys() : this.state.selectedKeys);
	...
	replaceSelection(e) {
		...
		let t = this.getKey(e);
		if (t == null) return;
		let n = this.canSelectItem(t) ? new gr([t], t, t) : new gr();
		this.state.setSelectedKeys(n);
	}
	setSelectedKeys(e) {
		if (this.selectionMode === "none") return;
		...
		let e = this.fullCollection ?? this.collection, t = [], n = (r) => {
			for (; r != null;) {
				if (this.canSelectItemIn(r, e)) {
					let i = e.getItem(r);
					i?.type === "item" && t.push(r), i?.hasChildNodes && (this.allowsCellSelection || i.type !== "item") && n(ur(lr(i, e))?.key ?? null);
				}
				r = e.getKeyAfter(r);
			}
		};
	...
	clearSelection() {
		!this.disallowEmptySelection && (this.state.selectedKeys === "all" || this.state.selectedKeys.size > 0) && this.state.setSelectedKeys(new gr());
	}
	toggleSelectAll() {
	...
	build(e, t) {
		return this.context = t, Sr(() => this.iterateCollection(e));
	}
	*iterateCollection(e) {
		let { children: t, items: n } = e;
		if (K.isValidElement(t) && t.type === K.Fragment) yield* this.iterateCollection({
	...
	*getFullNode(e, t, n, r) {
		if (K.isValidElement(e.element) && e.element.type === K.Fragment) {
			let i = [];
			K.Children.forEach(e.element.props.children, (e) => {
				i.push(e);
			});
			let a = e.index ?? 0;
		...
		if (K.isValidElement(i)) {
			...
			for (; !c.done && c.value;) {
				...
				let u = [...this.getFullNode({
					...
					key: l,
					index: s,
					wrapper: Cr(e.wrapper, a.wrapper)
				}, this.getChildState(t, a), n ? `${n}${i.key}` : i.key, r)];
				for (let t of u) {
					if (t.value = a.value ?? e.value ?? null, t.value && this.cache.set(t.value, t), e.type && t.type !== e.type) throw Error(`Unsupported type <${wr(t.type)}> in <${wr(r?.type ?? "unknown parent type")}>. Only <${wr(e.type)}> is supported.`);
					s++, yield t;
				}
				c = o.next(u);
			}
...
function Tr(e, t, n) {
	let r = (0, K.useMemo)(() => new xr(), []), { children: i, items: a, collection: o } = e;
	return (0, K.useMemo)(() => o || t(r.build({
		children: i,
		items: a
	}, n)), [
		r,
...
var Er = /*#__PURE__*/ (0, K.createContext)({ placement: "bottom" }), Dr = typeof HTMLElement < "u" && "inert" in HTMLElement.prototype;
function Or(e) {
	return e.dataset.liveAnnouncer === "true" || e.dataset.reactAriaTopLayer !== void 0;
}
var kr = /* @__PURE__ */ new WeakMap(), X = [];
function Ar(e, t) {
	let n = x(e?.[0]), r = t instanceof n.Element ? { root: t } : t, i = r?.root ?? document.body, a = r?.shouldUseInert && Dr, o = new Set(e), s = /* @__PURE__ */ new Set(), l = (e) => a && e instanceof n.HTMLElement ? e.inert : e.getAttribute("aria-hidden") === "true", u = (e, t) => {
	...
	if (S()) for (let t of e) {
		...
		for (; e && e !== i;) {
			let t = e.getRootNode();
			"shadowRoot" in t && d.add(t.shadowRoot), e = t.parentNode;
		}
	}
	let p = (e) => {
		...
		}, n = vn(c(e), e, NodeFilter.SHOW_ELEMENT, { acceptNode: t }), r = t(e);
		if (r === NodeFilter.FILTER_ACCEPT && m(e), r !== NodeFilter.FILTER_REJECT) {
			let e = n.nextNode();
			for (; e != null;) m(e), e = n.nextNode();
		}
	}, m = (e) => {
		let t = kr.get(e) ?? 0;
		l(e) && t === 0 || (t === 0 && u(e, !0), s.add(e), kr.set(e, t + 1));
	};
	X.length && X[X.length - 1].disconnect(), p(i);
	let h = new MutationObserver((e) => {
		for (let t of e) if (t.type === "childList") {
			if (t.target.isConnected && ![...o, ...s].some((e) => f(e, t.target))) for (let e of t.addedNodes) (e instanceof HTMLElement || e instanceof SVGElement) && Or(e) ? o.add(e) : e instanceof Element && p(e);
			if (S()) {
	...
	return X.push(_), () => {
		if (h.disconnect(), S()) for (let e of g) e.disconnect();
		for (let e of s) {
			let t = kr.get(e);
			t != null && (t === 1 ? (u(e, !1), kr.delete(e)) : kr.set(e, t - 1));
		}
		_ === X[X.length - 1] ? (X.pop(), X.length && X[X.length - 1].observe()) : X.splice(X.indexOf(_), 1);
	};
}
function jr(e) {
	let t = X[X.length - 1];
...
var Z = {
	...
	width: "totalWidth",
	height: "totalHeight"
}, Ir = {}, Lr = () => typeof document < "u" ? window.visualViewport : null;
function Rr(e, t) {
	...
	} else ({width: n, height: r, top: o, left: s} = Yr(e, !1)), c.top = e.scrollTop, c.left = e.scrollLeft, i = n, a = r;
	return ne() && (e.tagName === "BODY" || e.tagName === "HTML") && l && (c.top = 0, c.left = 0, o = t?.pageTop ?? 0, s = t?.pageLeft ?? 0), {
		width: n,
		height: r,
		totalWidth: i,
		totalHeight: a,
...
function Br(e, t, n, r, i, a, o) {
	let s = i.scroll[e] ?? 0, c = r[Pr[e]], l = o[e] + r.scroll[Z[e]] + a, u = o[e] + r.scroll[Z[e]] + c - a, d = t - s + r.scroll[Z[e]] + o[e] - r[Z[e]], f = t - s + n + r.scroll[Z[e]] + o[e] - r[Z[e]];
...
function Hr(e) {
	if (Ir[e]) return Ir[e];
	let [t, n] = e.split(" "), r = Z[t] || "right", i = Nr[r];
	Z[n] || (n = "center");
	let a = Pr[r], o = Pr[i];
	return Ir[e] = {
		placement: t,
...
function Ur(e, t, n, r, i, a, o, s, c, l, u) {
	...
	if (_[m] = Xt(_[m], v, y), d === p) {
		let t = s ? u[h] : u[Fr[h]];
		_[Mr[p]] = Math.floor(t - e[p] + i);
	} else _[p] = Math.floor(e[p] + e[h] + i);
	return _;
}
function Wr(e, t, n, r, i, a, o, s, c, l, u) {
	let d = (e.top == null ? c[Fr.height] - (e.bottom ?? 0) - o : e.top) - (c.scroll.top ?? 0), f = l ? n.top : 0, p = {
...
function Gr(e, t, n, r, i, a, o, s) {
	...
	return c === l ? Math.max(0, n[l] - (o.scroll[l] ?? 0) - (e[l] + (s ? t[l] : 0)) - (r[l] ?? 0) - r[Mr[l]] - i) : Math.max(0, e[u] + e[l] + (s ? t[l] : 0) - n[l] - n[u] + (o.scroll[l] ?? 0) - (r[l] ?? 0) - r[Mr[l]] - i);
}
function Kr(e, t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _) {
	let v = Hr(e), { size: y, crossAxis: b, crossSize: x, placement: S, crossPlacement: C } = v, w = Ur(t, s, n, v, u, d, l, f, m, h, c), T = u, E = Gr(s, l, t, i, a + u, v, c, g);
	if (o && n[y] > E) {
		let e = Hr(`${Mr[S]} ${C}`), r = Ur(t, s, n, e, u, d, l, f, m, h, c);
		Gr(s, l, t, i, a + u, e, c, g) > E && (v = e, w = r, T = u);
	}
	let D = "bottom";
	...
	let O = Br(b, w[b], n[x], s, c, a, l);
	w[b] += O;
	let k = Wr(w, s, l, f, i, a, n.height, D, c, g, _);
	p && p < k && (k = p), n.height = Math.min(n.height, k), w = Ur(t, s, n, v, T, d, l, f, m, h, c), O = Br(b, w[b], n[x], s, c, a, l), w[b] += O;
	let A = {}, j = t[b] - w[b] - i[Z[b]], M = j + .5 * t[x], N = m / 2 + h, P = Z[b] === "left" ? (i.left ?? 0) + (i.right ?? 0) : (i.top ?? 0) + (i.bottom ?? 0), F = n[x] - P - m / 2 - h;
	A[b] = Xt(Xt(M, t[b] + m / 2 - (w[b] + i[Z[b]]), t[b] + t[x] - m / 2 - (w[b] + i[Z[b]])), N, F), {placement: S, crossPlacement: C} = v, m ? j = A[b] : C === "right" ? j += t[x] : C === "center" && (j += t[x] / 2);
...
function qr(e) {
	let { placement: t, targetNode: n, overlayNode: r, scrollNode: i, padding: a, shouldFlip: o, boundaryElement: s, offset: c, crossOffset: l, maxHeight: u, arrowSize: d = 0, arrowBoundaryOffset: p = 0, targetRect: m } = e, h = Lr(), g = r instanceof HTMLElement ? Zr(r) : document.documentElement, _ = g === document.documentElement, v = window.getComputedStyle(g).position, y = !!v && v !== "static", b = _ ? Yr(n, !1, m) : Xr(n, g, !1, m);
	if (!_) {
		let { marginTop: e, marginLeft: t } = window.getComputedStyle(n);
		b.top += parseInt(e, 10) || 0, b.left += parseInt(t, 10) || 0;
	}
	let x = Yr(r, !0), S = Vr(r);
	x.width += (S.left ?? 0) + (S.right ?? 0), x.height += (S.top ?? 0) + (S.bottom ?? 0);
	let C = zr(i), w = Rr(s, h), T = Rr(g, h), E;
	if ((s.tagName === "BODY" || s.tagName === "HTML") && !_) {
		let e = Jr(g, !1);
		E = {
			top: -(e.top - w.top),
			left: -(e.left - w.left),
	...
	} else E = (s.tagName === "BODY" || s.tagName === "HTML") && _ ? {
		top: 0,
		left: 0,
		width: 0,
		height: 0
	...
	let D = f(s, g);
	return Kr(t, b, x, C, S, a, o, w, T, E, c, l, y, u, d, p, D, h);
}
function Jr(e, t) {
...
function Yr(e, t, n) {
	let { top: r, left: i, width: a, height: o } = n || Jr(e, t), { scrollTop: s, scrollLeft: c, clientTop: l, clientLeft: u } = document.documentElement;
	return {
		top: r + s - l,
		left: i + c - u,
		width: a,
...
function Xr(e, t, n, r) {
	...
	if (i.position === "fixed") a = r || Jr(e, n);
	else {
		a = Yr(e, n, r);
		let i = Yr(t, n), o = window.getComputedStyle(t);
...
function Zr(e) {
	...
	if (t && t === document.body && window.getComputedStyle(t).position === "static" && !Qr(t) && (t = document.documentElement), t == null) for (t = e.parentElement; t && !Qr(t);) t = t.parentElement;
...
function ei(e) {
	...
	(0, K.useEffect)(() => {
		...
		let e = (e) => {
			let r = n(e);
			if (!t.current || r instanceof Node && !f(r, t.current) || r instanceof HTMLInputElement || r instanceof HTMLTextAreaElement) return;
			let a = i || $r.get(t.current);
			a && a();
		};
...
function ni(e) {
	let { ref: t, box: n, onResize: r } = e, i = A(r);
	(0, K.useEffect)(() => {
		let e = t?.current;
		if (e) if (ti()) {
...
var ri = typeof document < "u" ? window.visualViewport : null;
function ii(e) {
	let { direction: t } = Ze(), { arrowSize: n, targetRef: r, overlayRef: i, arrowRef: a, scrollRef: o = i, placement: s = "bottom", containerPadding: c = 12, shouldFlip: l = !0, boundaryElement: u = typeof document < "u" ? document.body : null, offset: d = 0, crossOffset: f = 0, shouldUpdatePosition: p = !0, isOpen: m = !0, onClose: h, maxHeight: g, arrowBoundaryOffset: _ = 0, getTargetRect: y } = e, [b, x] = (0, K.useState)(null), S = [
		p,
		s,
		i.current,
		r.current,
		...
		_,
		n
	], C = (0, K.useRef)(ri?.scale);
	(0, K.useEffect)(() => {
		m && (C.current = ri?.scale);
	}, [m]);
	let w = (0, K.useCallback)(() => {
		if (p === !1 || !m || !i.current || !r.current || !u || ri?.scale !== C.current) return;
		let e = null;
		if (o.current && v(o.current)) {
		...
		let b = qr({
			...
			crossOffset: f,
			maxHeight: g,
			arrowSize: n ?? (a?.current ? Jr(a.current, !0).width : 0),
			arrowBoundaryOffset: _,
			targetRect: y?.(r.current)
		});
		if (!b.position) return;
		h.style.top = "", h.style.bottom = "", h.style.left = "", h.style.right = "", Object.keys(b.position).forEach((e) => h.style[e] = b.position[e] + "px"), h.style.maxHeight = b.maxHeight == null ? "" : b.maxHeight + "px";
		let S = W();
		if (e && S && o.current) {
			let t = S.getBoundingClientRect(), n = o.current.getBoundingClientRect(), r = t[e.type] - n[e.type];
	...
	U(() => {
		...
		return ri?.addEventListener("resize", t), ri?.addEventListener("scroll", n), () => {
			ri?.removeEventListener("resize", t), ri?.removeEventListener("scroll", n);
		};
	}, [w]);
...
function ai(e) {
	U(() => (window.addEventListener("resize", e, !1), () => {
...
function si(e) {
	let { ref: t, onInteractOutside: n, isDisabled: r, onInteractOutsideStart: i } = e, a = (0, K.useRef)({
		isPointerDown: !1,
		ignoreEmulatedMouseEvents: !1
	}), o = A((e) => {
		n && ci(e, t) && (i && i(e), a.current.isPointerDown = !0);
	}), s = A((e) => {
		n && n(e);
	});
	(0, K.useEffect)(() => {
		let e = a.current;
		if (r) return;
		let n = t.current, i = c(n);
		if (typeof PointerEvent < "u") {
			let n = (n) => {
				e.isPointerDown && ci(n, t) && s(n), e.isPointerDown = !1;
			};
...
function ci(e, t) {
	...
	if (r) {
		...
		if (!e || !f(e.documentElement, r) || r.closest("[data-react-aria-top-layer]")) return !1;
	}
...
var Q = [];
function li(e, t) {
	let { onClose: r, shouldCloseOnBlur: i, isOpen: a, isDismissable: o = !1, isKeyboardDismissDisabled: s = !1, shouldCloseOnInteractOutside: c } = e, l = (0, K.useRef)(void 0);
	(0, K.useEffect)(() => {
		if (a && !Q.includes(t)) return Q.push(t), () => {
			let e = Q.indexOf(t);
			e >= 0 && Q.splice(e, 1);
		};
	}, [a, t]);
	let u = () => {
		...
		let r = Q[Q.length - 1];
		l.current = r, (!c || c(n(e))) && r === t && e.stopPropagation();
	}, f = (e) => {
		(!c || c(n(e))) && (Q[Q.length - 1] === t && e.stopPropagation(), l.current === t && u()), l.current = void 0;
	}, p = (e) => {
		e.key === "Escape" && !s && !e.nativeEvent.isComposing && (e.stopPropagation(), e.preventDefault(), u());
	};
	si({
		ref: t,
		onInteractOutside: o && a ? f : void 0,
		onInteractOutsideStart: d
	});
	let { focusWithinProps: m } = re({
		isDisabled: !i,
		onBlurWithin: (e) => {
			!e.relatedTarget || An(e.relatedTarget) || (!c || c(e.relatedTarget)) && r?.();
		}
	});
	return {
		overlayProps: {
...
var ui = typeof document < "u" && window.visualViewport, di = 0, fi;
function pi(e = {}) {
	let { isDisabled: t } = e;
	U(() => {
		if (!t) return di++, di === 1 && (fi = m() ? hi() : mi()), () => {
			di--, di === 0 && fi();
		};
	}, [t]);
}
function mi() {
	...
	return te(e > 0 && ("scrollbarGutter" in document.documentElement.style ? gi(document.documentElement, "scrollbarGutter", "stable") : gi(document.documentElement, "paddingRight", `${e}px`)), gi(document.documentElement, "overflow", "hidden"));
}
function hi() {
	let e = gi(document.documentElement, "overflow", "hidden"), t, r = !1, i = (e) => {
		let i = n(e);
		t = en(i) ? i : tn(i, !0), r = !1;
		let a = i.ownerDocument.defaultView.getSelection();
		a && !a.isCollapsed && a.containsNode(i, !0) && (r = !0), e.composedPath().some((e) => e instanceof HTMLInputElement && e.type === "range") && (r = !0), "selectionStart" in i && "selectionEnd" in i && i.selectionStart < i.selectionEnd && i.ownerDocument.activeElement === i && (r = !0);
	}, a = document.createElement("style"), o = ce();
	o && (a.nonce = o), a.textContent = "@layer {\n  * {\n    overscroll-behavior: contain;\n  }\n}", document.head.prepend(a);
	let s = (e) => {
		if (!(e.touches.length === 2 || r)) {
		...
		let t = n(e), r = e.relatedTarget;
		r && Re(r) ? (r.focus({ preventScroll: !0 }), vi(r, Re(t))) : r || (t.parentElement?.closest("[tabindex]"))?.focus({ preventScroll: !0 });
	}, l = HTMLElement.prototype.focus;
	HTMLElement.prototype.focus = function(e) {
		let t = W(), n = t != null && Re(t);
		l.call(this, {
			...e,
			preventScroll: !0
		}), (!e || !e.preventScroll) && vi(this, n);
	};
	let u = te(_i(document, "touchstart", i, {
		passive: !1,
		capture: !0
	}), _i(document, "touchmove", s, {
		passive: !1,
		capture: !0
	}), _i(document, "blur", c, !0));
	return () => {
		e(), u(), a.remove(), HTMLElement.prototype.focus = l;
	};
}
function gi(e, t, n) {
	let r = e.style[t];
...
function vi(e, t) {
	t || !ui ? yi(e) : ui.addEventListener("resize", () => yi(e), { once: !0 });
}
function yi(e) {
	...
	for (; n && n !== t;) {
		...
		if (e !== document.documentElement && e !== document.body && e !== n) {
			...
			if (r.top < t.top || r.bottom > t.top + n.clientHeight) {
				let n = t.bottom;
				ui && (n = Math.min(n, ui.offsetTop + ui.height));
...
function bi(e, t) {
	let { triggerRef: n, popoverRef: r, groupRef: i, isNonModal: a, isKeyboardDismissDisabled: o, shouldCloseOnInteractOutside: s, ...c } = e, l = c.trigger === "SubmenuTrigger", { overlayProps: u, underlayProps: d } = li({
		isOpen: t.isOpen,
		onClose: t.close,
		shouldCloseOnBlur: !0,
		isDismissable: !a || l,
	...
	}, i ?? r), { overlayProps: f, arrowProps: p, placement: m, triggerAnchorPoint: h } = ii({
		...c,
		targetRef: n,
		overlayRef: r,
		isOpen: t.isOpen,
	...
	return pi({ isDisabled: a || !t.isOpen }), (0, K.useEffect)(() => {
		if (t.isOpen && r.current) return a ? jr(i?.current ?? r.current) : Ar([i?.current ?? r.current], { shouldUseInert: !0 });
	}, [
		a,
		t.isOpen,
		r,
...
function ra(e) {
	let { onDismiss: t, ...n } = e, r = Be(n, ut(na(ta), "@react-aria/overlays").format("dismiss")), i = () => {
		t && t();
	};
	return /*#__PURE__*/ K.createElement(dn, null, /*#__PURE__*/ K.createElement("button", {
		...r,
		tabIndex: -1,
		onClick: i,
		style: {
...
var ia = /*#__PURE__*/ K.forwardRef(({ children: e, ...t }, n) => {
	let r = (0, K.useRef)(!1), i = (0, K.useContext)(F), a = _(i || {}, {
		...t,
		register() {
			r.current = !0, i && i.register();
		}
	});
	return a.ref = E(n || i?.ref), D(i, a.ref), (0, K.useEffect)(() => {
		r.current ||= !0;
	}, []), /*#__PURE__*/ K.createElement(F.Provider, { value: a }, e);
});
function aa({ children: e }) {
	let t = (0, K.useMemo)(() => ({ register: () => {} }), []);
	return /*#__PURE__*/ K.createElement(F.Provider, { value: t }, e);
}
//#endregion
...
var oa = /*#__PURE__*/ (0, K.createContext)({});
function sa() {
	return (0, K.useContext)(oa) ?? {};
}
//#endregion
...
var ca = /*#__PURE__*/ K.createContext(null);
function la(e) {
	let t = ae(), { portalContainer: n = t ? null : document.body, isExiting: r } = e, [i, a] = (0, K.useState)(!1), o = (0, K.useMemo)(() => ({
		contain: i,
		setContain: a
	}), [i, a]), { getContainer: s } = sa();
	if (!e.portalContainer && s && (n = s()), !n) return null;
	let c = e.children;
	return e.disableFocusManagement || (c = /*#__PURE__*/ K.createElement(xn, {
		restoreFocus: !0,
		contain: (e.shouldContainFocus || i) && !r
	}, c)), c = /*#__PURE__*/ K.createElement(ca.Provider, { value: o }, /*#__PURE__*/ K.createElement(aa, null, c)), /*#__PURE__*/ Dt.createPortal(c, n);
}
function ua() {
	let e = (0, K.useContext)(ca)?.setContain;
	U(() => {
		e?.(!0);
	}, [e]);
}
...
function da(e) {
	let [t, n] = ft(e.isOpen, e.defaultOpen || !1, e.onOpenChange);
	return {
		isOpen: t,
		setOpen: n,
		open: (0, K.useCallback)(() => {
			n(!0);
		}, [n]),
		close: (0, K.useCallback)(() => {
			n(!1);
		}, [n]),
		toggle: (0, K.useCallback)(() => {
			n(!t);
		}, [n, t])
	};
}
...
var ha = /*#__PURE__*/ (0, K.createContext)(null), ga = /*#__PURE__*/ (0, K.createContext)(null), _a = /*#__PURE__*/ (0, K.forwardRef)(function(e, t) {
	[e, t] = s(e, t, ha);
	let n = (0, K.useContext)(Do), r = da(e), i = e.isOpen != null || e.defaultOpen != null || !n ? r : n, a = pa(t, i.isOpen) || e.isExiting || !1, o = xe(), { direction: c } = Ze();
	if (o) {
		let t = e.children;
		...
		})), /*#__PURE__*/ K.createElement(K.Fragment, null, t);
	}
	return i && !i.isOpen && !a ? null : /*#__PURE__*/ K.createElement(va, {
		...e,
...
function va({ state: e, isExiting: t, UNSTABLE_portalContainer: n, clearContexts: r, ...i }) {
	let a = (0, K.useRef)(null), o = (0, K.useRef)(null), s = (0, K.useContext)(ga), c = s && i.trigger === "SubmenuTrigger", { popoverProps: l, underlayProps: u, arrowProps: f, placement: p, triggerAnchorPoint: m } = bi({
		...i,
		offset: i.offset ?? 8,
		arrowRef: a,
		groupRef: c ? s : o
	}, e), h = i.popoverRef, g = fa(h, !!p) || i.isEntering || !1, y = d({
		...i,
	...
	}), b = !i.isNonModal || i.trigger === "SubmenuTrigger", [x, S] = (0, K.useState)(!1);
	U(() => {
		h.current && S(b && !h.current.querySelector("[role=dialog]"));
	}, [h, b]), (0, K.useEffect)(() => {
		x && (i.trigger !== "SubmenuTrigger" || ye() !== "pointer") && h.current && !v(h.current) && be(h.current);
	}, [
		x,
		h,
		i.trigger
	...
	let C = (0, K.useMemo)(() => {
		let e = y.children;
		if (r) for (let t of r) e = /*#__PURE__*/ K.createElement(t.Provider, { value: null }, e);
		return e;
	}, [y.children, r]), [w, E] = (0, K.useState)(null), D = (0, K.useCallback)(() => {
		i.triggerRef.current && E(i.triggerRef.current.getBoundingClientRect().width + "px");
	}, [i.triggerRef]);
	U(D, [D]), ni({
		ref: y.style?.["--trigger-width"] ? void 0 : i.triggerRef,
		onResize: D
	});
	let O = {
		...l.style,
		...
		...y.style,
		"--trigger-width": y.style?.["--trigger-width"] || w
	}, k = /*#__PURE__*/ K.createElement(T.div, {
		..._(B(i, { global: !0 }), l),
		...y,
	...
	}, !i.isNonModal && /*#__PURE__*/ K.createElement(ra, { onDismiss: e.close }), /*#__PURE__*/ K.createElement(Er.Provider, { value: {
		...f,
		placement: p,
		ref: a
	} }, C), /*#__PURE__*/ K.createElement(ra, { onDismiss: e.close }));
	return c ? /*#__PURE__*/ K.createElement(la, {
		...i,
		shouldContainFocus: x,
		isExiting: t,
		portalContainer: n ?? s?.current ?? void 0
	}, k) : /*#__PURE__*/ K.createElement(la, {
		...i,
		shouldContainFocus: x,
		isExiting: t,
		portalContainer: n
	}, !i.isNonModal && e.isOpen && /*#__PURE__*/ K.createElement("div", {
	...
	}, /*#__PURE__*/ K.createElement(ga.Provider, { value: o }, k)));
}
//#endregion
...
var ya = /*#__PURE__*/ (0, K.createContext)({}), ba = {};
ba = { longPressMessage: "اضغط مطولاً أو اضغط على Alt + السهم لأسفل لفتح القائمة" };
//#endregion
...
var xa = {};
xa = { longPressMessage: "Натиснете продължително или натиснете Alt+ стрелка надолу, за да отворите менюто" };
//#endregion
...
var Sa = {};
Sa = { longPressMessage: "Dlouhým stiskem nebo stisknutím kláves Alt + šipka dolů otevřete nabídku" };
//#endregion
...
var wa = {};
wa = { longPressMessage: "Drücken Sie lange oder drücken Sie Alt + Nach-unten, um das Menü zu öffnen" };
//#endregion
...
var Ta = {};
Ta = { longPressMessage: "Πιέστε παρατεταμένα ή πατήστε Alt + κάτω βέλος για να ανοίξετε το μενού" };
//#endregion
...
var Ea = {};
Ea = { longPressMessage: "Long press or press Alt + ArrowDown to open menu" };
//#endregion
...
var Da = {};
Da = { longPressMessage: "Mantenga pulsado o pulse Alt + flecha abajo para abrir el menú" };
//#endregion
...
var Oa = {};
Oa = { longPressMessage: "Menüü avamiseks vajutage pikalt või vajutage klahve Alt + allanool" };
//#endregion
...
var ka = {};
ka = { longPressMessage: "Avaa valikko painamalla pohjassa tai näppäinyhdistelmällä Alt + Alanuoli" };
//#endregion
...
var Aa = {};
Aa = { longPressMessage: "Appuyez de manière prolongée ou appuyez sur Alt\xA0+\xA0Flèche vers le bas pour ouvrir le menu." };
//#endregion
...
var ja = {};
ja = { longPressMessage: "לחץ לחיצה ארוכה או הקש Alt + ArrowDown כדי לפתוח את התפריט" };
//#endregion
...
var Ma = {};
Ma = { longPressMessage: "Dugo pritisnite ili pritisnite Alt + strelicu prema dolje za otvaranje izbornika" };
//#endregion
...
var Na = {};
Na = { longPressMessage: "Nyomja meg hosszan, vagy nyomja meg az Alt + lefele nyíl gombot a menü megnyitásához" };
//#endregion
...
var Pa = {};
Pa = { longPressMessage: "Premi a lungo o premi Alt + Freccia giù per aprire il menu" };
//#endregion
...
var Fa = {};
Fa = { longPressMessage: "長押しまたは Alt+下矢印キーでメニューを開く" };
//#endregion
...
var Ia = {};
Ia = { longPressMessage: "길게 누르거나 Alt + 아래쪽 화살표를 눌러 메뉴 열기" };
//#endregion
...
var La = {};
La = { longPressMessage: "Norėdami atidaryti meniu, nuspaudę palaikykite arba paspauskite „Alt + ArrowDown“." };
//#endregion
...
var Ra = {};
Ra = { longPressMessage: "Lai atvērtu izvēlni, turiet nospiestu vai nospiediet taustiņu kombināciju Alt + lejupvērstā bultiņa" };
//#endregion
...
var za = {};
za = { longPressMessage: "Langt trykk eller trykk Alt + PilNed for å åpne menyen" };
//#endregion
...
var Ba = {};
Ba = { longPressMessage: "Druk lang op Alt + pijl-omlaag of druk op Alt om het menu te openen" };
//#endregion
...
var Va = {};
Va = { longPressMessage: "Naciśnij i przytrzymaj lub naciśnij klawisze Alt + Strzałka w dół, aby otworzyć menu" };
//#endregion
...
var Ha = {};
Ha = { longPressMessage: "Pressione e segure ou pressione Alt + Seta para baixo para abrir o menu" };
//#endregion
...
var Ua = {};
Ua = { longPressMessage: "Prima continuamente ou prima Alt + Seta Para Baixo para abrir o menu" };
//#endregion
...
var Wa = {};
Wa = { longPressMessage: "Apăsați lung sau apăsați pe Alt + săgeată în jos pentru a deschide meniul" };
//#endregion
...
var Ga = {};
Ga = { longPressMessage: "Нажмите и удерживайте или нажмите Alt + Стрелка вниз, чтобы открыть меню" };
//#endregion
...
var Ka = {};
Ka = { longPressMessage: "Ponuku otvoríte dlhým stlačením alebo stlačením klávesu Alt + klávesu so šípkou nadol" };
//#endregion
...
var qa = {};
qa = { longPressMessage: "Za odprtje menija pritisnite in držite gumb ali pritisnite Alt+puščica navzdol" };
//#endregion
...
var Ja = {};
Ja = { longPressMessage: "Dugo pritisnite ili pritisnite Alt + strelicu prema dole da otvorite meni" };
//#endregion
...
var Ya = {};
Ya = { longPressMessage: "Håll nedtryckt eller tryck på Alt + pil nedåt för att öppna menyn" };
//#endregion
...
var Xa = {};
Xa = { longPressMessage: "Menüyü açmak için uzun basın veya Alt + Aşağı Ok tuşuna basın" };
//#endregion
...
var Za = {};
Za = { longPressMessage: "Довго або звичайно натисніть комбінацію клавіш Alt і стрілка вниз, щоб відкрити меню" };
//#endregion
...
var Qa = {};
Qa = { longPressMessage: "长按或按 Alt + 向下方向键以打开菜单" };
//#endregion
...
var $a = {};
$a = { longPressMessage: "長按或按 Alt+向下鍵以開啟功能表" };
//#endregion
...
function to(e, t, n) {
	...
	(0, K.useEffect)(() => {
		n && n.current && $r.set(n.current, t.close);
	});
	let a;
...
function ro(e, t, n) {
	let { type: r = "menu", isDisabled: i, trigger: a = "press" } = e, o = me(), { triggerProps: s, overlayProps: c } = to({ type: r }, t, n), u = (e) => {
	...
	}, d = ut(no(eo), "@react-aria/menu"), { longPressProps: f } = ar({
		...
		onPressStart(e) {
			e.pointerType !== "touch" && e.pointerType !== "keyboard" && !i && (l(e.target), t.open(e.pointerType === "virtual" ? "first" : null));
		},
		onPress(e) {
			e.pointerType === "touch" && !i && (l(e.target), t.toggle());
		}
	};
...
function ao(e, t, n) {
	...
	let s = B(e, { labelable: !0 }), { listProps: c } = rr({
		...o,
		ref: n,
...
function oo(e, t, a) {
	let { id: o, key: s, closeOnSelect: c, shouldCloseOnSelect: l, isVirtualized: u, "aria-haspopup": d, onPressStart: f, onPressUp: p, onPress: m, onPressChange: h, onPressEnd: g, onClick: v, onHoverStart: x, onHoverChange: S, onHoverEnd: C, onKeyDown: w, onKeyUp: T, onFocus: E, onFocusChange: D, onBlur: O, selectionManager: k = t.selectionManager } = e, A = !!d, j = A && e["aria-expanded"] === "true", M = e.isDisabled ?? k.isDisabled(s), N = e.isSelected ?? k.isSelected(s), F = io.get(t), I = t.collection.getItem(s), L = e.onClose || F.onClose, R = i(), te = () => {
		if (!A && (I?.props?.onAction ? I.props.onAction() : e.onAction && e.onAction(s), F.onAction)) {
			let e = F.onAction;
			e(s, I?.value);
		}
	}, z = "menuitem";
	A || (k.selectionMode === "single" ? z = "menuitemradio" : k.selectionMode === "multiple" && (z = "menuitemcheckbox"));
	let ne = P(), re = P(), ie = P(), V = {
		id: o,
	...
	if (k.selectionMode !== "none" && !A && (V["aria-checked"] = N), u) {
		let e = Number(I?.index);
		V["aria-posinset"] = Number.isNaN(e) ? void 0 : e + 1, V["aria-setsize"] = hr(t.collection);
	}
	let ae = (0, K.useRef)(!1), oe = (e) => {
		h?.(e), ae.current = e;
	}, se = (0, K.useRef)(null), ce = (e) => {
		e.pointerType !== "keyboard" && (se.current = { pointerType: e.pointerType }), e.pointerType === "mouse" && (ae.current || e.target.click()), p?.(e);
	}, le = (e) => {
		v?.(e), te(), ve(e, R, I.props.href, I?.props.routerOptions);
		let t = se.current?.pointerType === "keyboard" ? se.current?.key === "Enter" || k.selectionMode === "none" || k.isLink(s) : k.selectionMode !== "multiple" || k.isLink(s);
		t = l ?? c ?? t, L && !A && t && L(), se.current = null;
	}, { itemProps: ue, isFocused: H } = or({
		id: o,
		selectionManager: k,
		key: s,
		ref: a,
		...
		isDisabled: M,
		onHoverStart(e) {
			!r() && !(j && d) && (k.setFocused(!0), k.setFocusedKey(s)), x?.(e);
		},
		onHoverChange: S,
		onHoverEnd: C
	}), { keyboardProps: me } = _e({
			...
			switch (e.key) {
				case " ":
					se.current = {
						...
						key: " "
					}, n(e).click(), y("keyboard");
					break;
				case "Enter":
					se.current = {
						pointerType: "keyboard",
						key: "Enter"
					}, n(e).tagName !== "A" && n(e).click(), y("keyboard");
					break;
				default:
					A || e.continuePropagation(), w?.(e);
					break;
			}
		},
		onKeyUp: T
	}), { focusableProps: ge } = ee({
		onBlur: O,
		onFocus: E,
		onFocusChange: D
	}, a), ye = B(I?.props);
	...
	return {
		menuItemProps: {
			...
			..._(ye, be, A ? {
				onFocus: ue.onFocus,
				"data-collection": ue["data-collection"],
				"data-key": ue["data-key"]
			} : ue, U, pe, me, ge, F.shouldUseVirtualFocus || A ? { onMouseDown: (e) => e.preventDefault() } : void 0, M ? void 0 : { onClick: le }),
			tabIndex: ue.tabIndex != null && j && !F.shouldUseVirtualFocus ? -1 : ue.tabIndex
		},
		labelProps: { id: ne },
		descriptionProps: { id: re },
		keyboardShortcutProps: { id: ie },
		isFocused: H,
		isFocusVisible: H && k.isFocused && r() && !j,
		isSelected: N,
		isPressed: fe,
		isDisabled: M
	};
...
function so(e) {
	let { heading: t, "aria-label": n } = e, r = me();
	return {
...
function co(e) {
	let t = da(e), [n, r] = (0, K.useState)(null), [i, a] = (0, K.useState)([]), o = () => {
		a([]), t.close();
	}, s = (e, t) => {
...
function uo(e) {
	let { onExpandedChange: t } = e, [n, r] = ft(e.expandedKeys ? new Set(e.expandedKeys) : void 0, e.defaultExpandedKeys ? new Set(e.defaultExpandedKeys) : /* @__PURE__ */ new Set(), t), i = vr(e), a = (0, K.useMemo)(() => e.disabledKeys ? new Set(e.disabledKeys) : /* @__PURE__ */ new Set(), [e.disabledKeys]), o = Tr(e, (0, K.useCallback)((e) => new lo(e, { expandedKeys: n }), [n]), null);
	return (0, K.useEffect)(() => {
...
var po = /*#__PURE__*/ (0, K.createContext)(null), mo = /*#__PURE__*/ (0, K.createContext)(null), ho = /*#__PURE__*/ (0, K.createContext)(null), go = /*#__PURE__*/ (0, K.createContext)(null);
function _o(e) {
	let t = co(e), n = (0, K.useRef)(null), { menuTriggerProps: r, menuProps: i } = ro({
		...e,
		type: "menu"
	}, t, n), a = (0, K.useRef)(null);
	return xe() ? null : /*#__PURE__*/ K.createElement(C, { values: [
		[po, {
			...i,
			ref: a
		}],
	...
	] }, /*#__PURE__*/ K.createElement(ia, {
		...r,
		ref: n,
		isPressed: t.isOpen
	}, e.children));
}
var vo = /*#__PURE__*/ (0, K.createContext)(null);
(class extends ht {
	static {
...
var yo = /*#__PURE__*/ (0, K.forwardRef)(function(e, t) {
	return [e, t] = s(e, t, po), /*#__PURE__*/ K.createElement(jt, { content: /*#__PURE__*/ K.createElement(Ht, e) }, (n) => /*#__PURE__*/ K.createElement(bo, {
		props: e,
		collection: n,
		menuRef: t
	}));
});
function bo({ props: e, collection: t, menuRef: n }) {
	[e, n] = s(e, n, pt);
	let { filter: r, ...i } = e, a = (0, K.useMemo)(() => r ? t.filter(r) : t, [t, r]), o = uo({
		...e,
		collection: a,
		children: void 0
	}), c = (0, K.useContext)(ho), { isVirtualized: l, CollectionRoot: u } = (0, K.useContext)(Jt), { menuProps: f } = ao({
		...e,
		isVirtualized: l,
		onClose: e.onClose || c?.close
	}, o, n), p = d({
		...e,
		children: void 0,
	...
	o.collection.size === 0 && e.renderEmptyState && (m = /*#__PURE__*/ K.createElement("div", {
		role: "menuitem",
		style: { display: "contents" }
	}, e.renderEmptyState()));
	let h = B(e, { global: !0 });
	return /*#__PURE__*/ K.createElement(xn, null, /*#__PURE__*/ K.createElement(T.div, {
		..._(h, p, f),
		ref: n,
		slot: e.slot || void 0,
		"data-empty": o.collection.size === 0 || void 0,
		onScroll: e.onScroll
	}, /*#__PURE__*/ K.createElement(C, { values: [
		[mo, o],
		[gn, { elementType: "div" }],
		[Wt, {
			name: "MenuSection",
		...
		[Co, { shouldCloseOnSelect: e.shouldCloseOnSelect }],
		[pt, null],
		[mt, null],
		[go, o.selectionManager],
		[ho, c ?? co({})]
	] }, /*#__PURE__*/ K.createElement(mn, null, /*#__PURE__*/ K.createElement(u, {
		collection: o.collection,
		persistedKeys: Yt(o.selectionManager.focusedKey),
		scrollRef: n
	}))), m));
}
var xo = class extends br {
	constructor(e, t) {
...
function So(e, t, n, r = "react-aria-MenuSection") {
	let i = (0, K.useContext)(mo), { CollectionBranch: a } = (0, K.useContext)(Jt), [o, s] = ue(), { headingProps: c, groupProps: l } = so({
		heading: s,
		...
		style: n.props?.style,
		values: void 0
	}), f = (0, K.useContext)(go), p = vr(e), m = e.selectionMode == null ? f : new xo(f, p), h = w(Co)?.shouldCloseOnSelect, g = B(e, { global: !0 });
	return delete g.id, /*#__PURE__*/ K.createElement(T.section, {
		..._(g, u, l),
		ref: t
	}, /*#__PURE__*/ K.createElement(C, { values: [
		[fn, {
		...
		[go, m],
		[Co, { shouldCloseOnSelect: e.shouldCloseOnSelect ?? h }]
	] }, /*#__PURE__*/ K.createElement(a, {
		collection: i.collection,
		parent: n
	})));
}
var Co = /*#__PURE__*/ (0, K.createContext)(null), wo = /*#__PURE__*/ zt(_t, function(e, t, n) {
	[e, t] = s(e, t, Co);
	let r = w(Co)?.id, i = (0, K.useContext)(mo), a = E(t), o = (0, K.useContext)(go), { isVirtualized: c } = (0, K.useContext)(Jt), { menuItemProps: l, labelProps: f, descriptionProps: p, keyboardShortcutProps: m, ...h } = oo({
		...e,
		id: r,
		key: n.key,
		selectionManager: o,
		isVirtualized: c
	}, i, a), { hoverProps: g, isHovered: v } = de({ isDisabled: h.isDisabled }), y = d({
		...e,
		id: void 0,
		children: n.rendered,
		...
		values: {
			...h,
			isHovered: v,
			isFocusVisible: h.isFocusVisible,
			selectionMode: o.selectionMode,
			selectionBehavior: o.selectionBehavior,
			hasSubmenu: !!e["aria-haspopup"],
			isOpen: e["aria-expanded"] === "true"
		}
	}), b = e.href ? T.a : T.div, x = B(e, { global: !0 });
	return delete x.id, delete x.onClick, /*#__PURE__*/ K.createElement(b, {
		..._(x, y, l, g),
		ref: a,
...
function To(e, t) {
	let { role: n = "dialog" } = e, r = P();
	r = e["aria-label"] ? void 0 : r;
	let i = (0, K.useRef)(!1);
	return (0, K.useEffect)(() => {
		if (t.current && !v(t.current)) {
			be(t.current);
			let e = setTimeout(() => {
				(W() === t.current || W() === document.body) && (i.current = !0, t.current && (t.current.blur(), be(t.current)), i.current = !1);
			}, 500);
			return () => {
				clearTimeout(e);
			};
		}
	}, [t]), ua(), (0, K.useRef)(!1), (0, K.useEffect)(() => {}), {
		dialogProps: {
			...B(e, { labelable: !0 }),
			role: n,
			tabIndex: -1,
...
var Eo = /*#__PURE__*/ (0, K.createContext)(null), Do = /*#__PURE__*/ (0, K.createContext)(null), Oo = /*#__PURE__*/ (0, K.forwardRef)(function(e, t) {
	let n = e["aria-labelledby"];
	[e, t] = s(e, t, Eo);
	let { dialogProps: r, titleProps: i } = To({
		...e,
		"aria-labelledby": n
	}, t), a = (0, K.useContext)(Do);
	...
	return /*#__PURE__*/ K.createElement(T.section, {
		..._(c, o, r),
		render: e.render,
		ref: t,
		slot: e.slot || void 0
	}, /*#__PURE__*/ K.createElement(C, { values: [[Zt, { slots: {
		[u]: {},
		title: {
			...i,
			level: 2
...
function ko(e, t, n) {
	let { overlayProps: r, underlayProps: i } = li({
		...e,
		isOpen: t.isOpen,
		onClose: t.close
	}, n);
	return pi({ isDisabled: !t.isOpen }), ua(), (0, K.useEffect)(() => {
		if (t.isOpen && n.current) return Ar([n.current], { shouldUseInert: !0 });
	}, [t.isOpen, n]), {
		modalProps: _(r),
		underlayProps: i
	};
...
function Ao() {
	...
	return (0, K.useEffect)(() => {
		let e = (e) => {
			...
			$ && $.scale > 1 || Re(n(t)) && (i = requestAnimationFrame(() => {
				let t = W();
				(!t || !Re(t)) && e({
		...
		return e(jo()), m() && window.addEventListener("blur", a, !0), $ ? $.addEventListener("resize", t) : window.addEventListener("resize", t), () => {
			cancelAnimationFrame(i), m() && window.removeEventListener("blur", a, !0), $ ? $.removeEventListener("resize", t) : window.removeEventListener("resize", t);
		};
	}, []), t;
}
function jo() {
...
var Mo = /*#__PURE__*/ (0, K.createContext)(null), No = /*#__PURE__*/ (0, K.createContext)(null), Po = /*#__PURE__*/ (0, K.forwardRef)(function(e, t) {
	if ((0, K.useContext)(No)) return /*#__PURE__*/ K.createElement(Ro, {
		...e,
		modalRef: t
	}, e.children);
...
function Fo(e, t) {
	[e, t] = s(e, t, Mo);
	let n = (0, K.useContext)(Do), r = da(e), i = e.isOpen != null || e.defaultOpen != null || !n ? r : n, a = E(t), o = (0, K.useRef)(null), c = pa(a, i.isOpen), l = pa(o, i.isOpen), u = c || l || e.isExiting || !1, d = ae();
	return !i.isOpen && !u || d ? null : /*#__PURE__*/ K.createElement(Lo, {
		...e,
		state: i,
		isExiting: u,
		overlayRef: a,
...
var Io = /*#__PURE__*/ (0, K.forwardRef)(Fo);
function Lo({ UNSTABLE_portalContainer: e, ...t }) {
	let n = t.modalRef, { state: r } = t, { modalProps: i, underlayProps: a } = ko(t, r, n), o = fa(t.overlayRef) || t.isEntering || !1, s = d({
		...t,
	...
	if (typeof document < "u") {
		let e = en(document.body) ? document.body : document.scrollingElement || document.documentElement, t = e.getBoundingClientRect().width % 1, n = e.getBoundingClientRect().height % 1;
	...
	return /*#__PURE__*/ K.createElement(la, {
		isExiting: t.isExiting,
		portalContainer: e
	}, /*#__PURE__*/ K.createElement(T.div, {
		..._(B(t, { global: !0 }), a),
		...s,
		style: f,
		ref: t.overlayRef,
	...
	}, /*#__PURE__*/ K.createElement(C, { values: [[No, {
		modalProps: i,
		modalRef: n,
		isExiting: t.isExiting,
...
function Ro(t) {
	let { modalProps: n, modalRef: r, isExiting: i, isDismissable: a } = (0, K.useContext)(No), o = (0, K.useContext)(Do), s = E((0, K.useMemo)(() => e(t.modalRef, r), [t.modalRef, r])), c = fa(s), l = d({
		...t,
	...
	return /*#__PURE__*/ K.createElement(T.div, {
		..._(B(t, { global: !0 }), n),
		...l,
		ref: s,
		"data-entering": c || void 0,
		"data-exiting": i || void 0
	}, a && /*#__PURE__*/ K.createElement(ra, { onDismiss: o.close }), l.children);
}
//#endregion
...
function zo() {
	...
	return {
		brand: e,
		components: k[e].components
	};
}
//#endregion
//#region ../../packages/icons/src/custom/FilterIcon.tsx
var Bo = (0, K.forwardRef)(function({ className: e, width: t = 16, height: n = 16, ...r }, i) {
...
function Xs({ items: e, "aria-label": t, onNavigate: n }) {
	...
	return /* @__PURE__ */ (0, G.jsx)(Js, {
		...
		children: e.map((e) => e.kind === "current" ? /* @__PURE__ */ (0, G.jsx)("span", {
			...
			children: e.label
		}, e.key) : e.kind === "back" ? /* @__PURE__ */ (0, G.jsxs)(pe, {
			href: e.href,
			variant: "standalone",
			size: "auto",
...
function tc({ openLabel: e, closeLabel: t, label: n, navigationLabel: r, items: i, currentPath: a }) {
	...
	}), o ? /* @__PURE__ */ (0, G.jsxs)("section", {
		id: u,
		ref: f,
		className: j("lg:hidden absolute left-0 right-0 z-overlay bg-surface", "header-mobile-panel border-b header-main-row-panel overflow-y-auto scrollbar-subtle", "motion-safe:animate-[header-menu-slide-in_300ms_ease-out]"),
